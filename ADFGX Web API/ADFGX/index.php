...
if (!empty($_POST['txtSearch']))
{
	...
	$Query .= " (perm_combination_1 LIKE '%".mysql_real_escape_string($_POST['txtSearch'])."%'";
	$Query .= " OR perm_combination_2 LIKE '%".mysql_real_escape_string($_POST['txtSearch'])."%'";
	$Query .= " OR perm_combination_3 LIKE '%".mysql_real_escape_string($_POST['txtSearch'])."%'";
	$Query .= " OR perm_combination_4 LIKE '%".mysql_real_escape_string($_POST['txtSearch'])."%'";
	$Query .= " OR perm_combination_5 LIKE '%".mysql_real_escape_string($_POST['txtSearch'])."%'";
	$Query .= " OR perm_combination_6 LIKE '%".mysql_real_escape_string($_POST['txtSearch'])."%'";
	$Query .= " OR perm_combination_7 LIKE '%".mysql_real_escape_string($_POST['txtSearch'])."%'";
	$Query .= " OR perm_combination_8 LIKE '%".mysql_real_escape_string($_POST['txtSearch'])."%'";
	$Query .= " OR perm_combination_9 LIKE '%".mysql_real_escape_string($_POST['txtSearch'])."%'";
	$Query .= " OR perm_combination_10 LIKE '%".mysql_real_escape_string($_POST['txtSearch'])."%'";
	$Query .= " OR perm_combination_11 LIKE '%".mysql_real_escape_string($_POST['txtSearch'])."%'";
	$Query .= " OR perm_combination_12 LIKE '%".mysql_real_escape_string($_POST['txtSearch'])."%'";
	$Query .= " OR perm_combination_13 LIKE '%".mysql_real_escape_string($_POST['txtSearch'])."%'";
	$Query .= " OR perm_combination_14 LIKE '%".mysql_real_escape_string($_POST['txtSearch'])."%'";
	$Query .= " OR perm_combination_15 LIKE '%".mysql_real_escape_string($_POST['txtSearch'])."%'";
	$Query .= " OR perm_combination_16 LIKE '%".mysql_real_escape_string($_POST['txtSearch'])."%'";
	$Query .= " OR perm_combination_17 LIKE '%".mysql_real_escape_string($_POST['txtSearch'])."%'";
	$Query .= " OR perm_combination_18 LIKE '%".mysql_real_escape_string($_POST['txtSearch'])."%'";
	$Query .= " OR perm_combination_19 LIKE '%".mysql_real_escape_string($_POST['txtSearch'])."%'";
	$Query .= " OR perm_combination_20 LIKE '%".mysql_real_escape_string($_POST['txtSearch'])."%'";
	$Query .= " OR perm_combination_21 LIKE '%".mysql_real_escape_string($_POST['txtSearch'])."%'";
	$Query .= " OR perm_combination_22 LIKE '%".mysql_real_escape_string($_POST['txtSearch'])."%'";
	$Query .= " OR perm_combination_23 LIKE '%".mysql_real_escape_string($_POST['txtSearch'])."%'";
	$Query .= " OR perm_combination_24 LIKE '%".mysql_real_escape_string($_POST['txtSearch'])."%'";
	$Query .= " OR perm_combination_25 LIKE '%".mysql_real_escape_string($_POST['txtSearch'])."%'";
	$Query .= " OR perm_combination_26 LIKE '%".mysql_real_escape_string($_POST['txtSearch'])."%'";
	$Query .= " OR perm_combination_27 LIKE '%".mysql_real_escape_string($_POST['txtSearch'])."%'";
	$Query .= " OR perm_combination_28 LIKE '%".mysql_real_escape_string($_POST['txtSearch'])."%'";
	$Query .= " OR perm_combination_29 LIKE '%".mysql_real_escape_string($_POST['txtSearch'])."%'";
	$Query .= " OR perm_combination_30 LIKE '%".mysql_real_escape_string($_POST['txtSearch'])."%'";
	$Query .= " OR perm_combination_31 LIKE '%".mysql_real_escape_string($_POST['txtSearch'])."%'";
	$Query .= " OR perm_combination_32 LIKE '%".mysql_real_escape_string($_POST['txtSearch'])."%'";
	$Query .= " OR perm_combination_33 LIKE '%".mysql_real_escape_string($_POST['txtSearch'])."%'";
	$Query .= " OR perm_combination_34 LIKE '%".mysql_real_escape_string($_POST['txtSearch'])."%'";
	$Query .= " OR perm_combination_35 LIKE '%".mysql_real_escape_string($_POST['txtSearch'])."%'";
	$Query .= " OR perm_combination_36 LIKE '%".mysql_real_escape_string($_POST['txtSearch'])."%'";
	$Query .= " OR perm_combination_37 LIKE '%".mysql_real_escape_string($_POST['txtSearch'])."%'";
	$Query .= " OR perm_combination_38 LIKE '%".mysql_real_escape_string($_POST['txtSearch'])."%'";
	$Query .= " OR perm_combination_39 LIKE '%".mysql_real_escape_string($_POST['txtSearch'])."%'";
	$Query .= " OR perm_combination_40 LIKE '%".mysql_real_escape_string($_POST['txtSearch'])."%'";
	$Query .= " OR perm_combination_41 LIKE '%".mysql_real_escape_string($_POST['txtSearch'])."%'";
	$Query .= " OR perm_combination_42 LIKE '%".mysql_real_escape_string($_POST['txtSearch'])."%'";
	$Query .= " OR perm_combination_43 LIKE '%".mysql_real_escape_string($_POST['txtSearch'])."%'";
	$Query .= " OR perm_combination_44 LIKE '%".mysql_real_escape_string($_POST['txtSearch'])."%'";
	$Query .= " OR perm_combination_45 LIKE '%".mysql_real_escape_string($_POST['txtSearch'])."%'";
	$Query .= " OR perm_combination_46 LIKE '%".mysql_real_escape_string($_POST['txtSearch'])."%'";
	$Query .= " OR perm_combination_47 LIKE '%".mysql_real_escape_string($_POST['txtSearch'])."%'";
	$Query .= " OR perm_combination_48 LIKE '%".mysql_real_escape_string($_POST['txtSearch'])."%')";
